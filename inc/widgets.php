 ...
 */
add_filter( 'dynamic_sidebar_params', 'anzu_widget_classes' );

if ( ! function_exists( 'anzu_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function anzu_widget_classes( $params ) {
...
} // End of if function_exists( 'anzu_widget_classes' ).
...
if ( ! function_exists( 'anzu_widgets_init' ) ) {
	...
	function anzu_widgets_init() {
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'anzu' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'anzu' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'anzu' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'anzu' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'anzu' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'anzu' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'anzu' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'anzu' ),

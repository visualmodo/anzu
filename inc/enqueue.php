...
if ( ! function_exists( 'anzu_scripts' ) ) {
	...
	function anzu_scripts() {
		...
		wp_enqueue_style( 'anzu-styles', get_template_directory_uri() . '/assets/css/theme.min.css', array(), $css_version );

		wp_enqueue_script( 'jquery' );

		$js_version = $theme_version . '.' . filemtime( get_template_directory() . '/assets/js/theme.min.js' );
		wp_enqueue_script( 'anzu-scripts', get_template_directory_uri() . '/assets/js/theme.min.js', array(), $js_version, true );
